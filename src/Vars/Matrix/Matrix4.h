...
public:
	...
	*/
	vec::Vector3 operator*(const vec::Vector3& v) const;
	...
	* vector.
	*/
	static mat4 translate(const vec::Vector3& v);
...
template <typename type>
inline vec::Vector3 mat4<type>::operator*(const vec::Vector3& v) const
{
	vec::Vector3 r;
...
template <typename type>
mat4<type> mat4<type>::translate(const vec::Vector3& v)
{
